...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand" href="home">Shoe</a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
            <ul class="navbar-nav m-auto">
                ...
                <c:if test="${sessionScope.acc != null}">
                     <li class="nav-item">
                         <a class="nav-link" href="updateProfile">Hello ${sessionScope.acc.user}</a>
                </li>
                <li class="nav-item">
...
<section class="jumbotron text-center">
    <div class="container">
        ...
        <p class="lead text-muted mb-0">Uy tín tạo nên thương hiệu với hơn 10 năm cung cấp các sản phầm uy tín</p>
    </div>
</section>
<!--end of menu-->
